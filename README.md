...
- URL Shortener with a 14-day default retention policy and custom retention up to 365 days
- Master URL Lister: fetch one URL and extract/normalize all linked URLs
- URL Checker: DNS records, HTTP status, redirect chain, root-domain parsing, optional VirusTotal reputation
- Email/Sender Analyzer: upload `.eml`, inspect From/Reply-To/Return-Path, MX, SPF TXT, DMARC TXT, Authentication-Results, Received chain, and embedded URLs
- Quick defang/refang toolkit for phishing notes
